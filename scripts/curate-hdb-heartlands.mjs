...
const COLLECTION_NAME = "hdb heartlands"
const CONCURRENCY = 5
          ...
          messages: [
            {
              role: "system",
              content:
                "You curate a BACKGROUND-image collection for SINGAPORE HDB PROPERTY TikTok slideshows. Slides overlay white text on these images, so they must read as atmospheric backgrounds. FIT: authentic Singapore public-housing and heartland imagery — HDB blocks and estates, void decks, common corridors, lift lobbies, estate playgrounds, BTO or resale flat interiors, hawker centres and kopitiams, neighbourhood shops, MRT-adjacent estate views, heartland skylines at any time of day. UNFIT: luxury condos, Marina Bay Sands, CBD skyline glamour shots, hotels and resort pools, non-Singapore housing, ANY prominent visible person or face (small distant figures in an estate scene are acceptable), text-heavy graphics, floor plans, memes, brochures, catalog or stock-photo product shots. When unsure whether housing is Singapore public housing, judge by architecture: dense slab or tower blocks with corridors and void decks fit; glassy condo towers do not. Respond with JSON only.",
            },
            {
              role: "user",
              content: [
