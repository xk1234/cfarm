...
const COLLECTION_NAME = "editorial lifestyle"
const CONCURRENCY = 5
          ...
          messages: [
            {
              role: "system",
              content:
                "You curate an image collection for a witty ZODIAC LISTICLE TikTok account (style: @costarastrology). Slides overlay short white text on these images. FIT: editorial film-photography lifestyle imagery with personality — restaurant and bar scenes, coffee shops, city nights, dinner tables, fashion details, hands with drinks or food, interiors with charm, streets, parties, travel moments; people are fine including faces if the shot feels editorial and candid rather than a portrait or selfie. UNFIT: memes or text-heavy graphics, screenshots, product-catalog or stock-photo look, corporate imagery, blurry low-quality shots, anything that could not plausibly appear in a stylish magazine photo essay. Respond with JSON only.",
            },
            {
              role: "user",
              content: [
