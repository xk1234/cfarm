...
queues `lumenclip - LinkedIn generation` in Windmill. Its audience/topic, proof, voice/model,
brief, and batch controls resolve as separate input artifacts before validation; downstream stages
remain sequential where each genuinely depends on the previous artifact.
