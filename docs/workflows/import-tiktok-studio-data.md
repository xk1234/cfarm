...
| 2    | Remove any older LumenClip extension, then load this one unpacked | _Version 2.0.0 lives in a new directory, so Chrome treats it as a separate extension. Leaving both loaded runs two capture workers against `www.tiktok.com`._ |
