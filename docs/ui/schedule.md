...
- [Schedule page](../jobs/index.mdx) explains the visible calendar,
  screenshots, filters, statuses, details, rescheduling, and cancellation.
- [Backend scheduling](../jobs/backend.md) explains due slots, generation
  lead times, Appwrite jobs, retries, and provider posting.
- [Manual publication and linking](../jobs/manual-linking.md) explains
