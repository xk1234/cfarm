...
The same shell supports slideshow and video automations, although runner and
format coverage varies by template. X and Threads use a separate social editor
model.
