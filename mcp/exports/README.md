...
templates, collections, outputs, or media without first creating an analytics
report.
...
| ----------------- | -------------------- | -------- | ---------------------------------------------------------------------------- |
| `object_types`    | string[]             | yes      | Templates, collections, outputs, publication evidence, or analytics reports. |
