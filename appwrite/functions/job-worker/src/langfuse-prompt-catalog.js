...
export const LUMENCLIP_PROMPT_DEFINITIONS = {
    ...
    ], ["stage_system_prefix", "slop_rule", "brand_profile", "draft"], "lib/generation-chain.ts"),
    ...
    ], ["reply_style", "style_instruction", "slop_rule", "comment_context"], "lib/tiktok-comment-replies.ts"),
