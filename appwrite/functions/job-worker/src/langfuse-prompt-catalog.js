// Generated from lib/langfuse-prompt-catalog.ts. Do not edit by hand.
export const LUMENCLIP_PROMPT_DEFINITIONS = {
    composeRepurpose: chatPrompt("lumenclip/compose-repurpose", [
        {
            role: "system",
    ...
    ], ["limits", "source_material"], "app/api/compose/repurpose/route.ts"),
    templateHookGeneration: chatPrompt("lumenclip/template-hook-generation", [
        {
            role: "system",
    ...
    ], ["template_name", "existing_hooks"], "app/api/templates/hooks/route.ts"),
    imageCaption: chatPrompt("lumenclip/image-caption", [
        {
            role: "system",
    ...
    videoCopy: chatPrompt("lumenclip/video-copy", [
        { role: "system", content: "{{system_prompt}}" },
        { role: "user", content: "{{user_prompt}}" },
    ], ["system_prompt", "user_prompt"], "lib/video-copy-generation.ts; lib/video-copy-prompt.ts"),
    tiktokSlideshowTranscription: chatPrompt("lumenclip/tiktok-slideshow-transcription", [
        {
            role: "system",
    ...
    ], ["slide_count", "post_id"], "lib/tiktok-slideshow-transcription.ts"),
    slideshowToneAnalysis: chatPrompt("lumenclip/slideshow-tone-analysis", [
        {
            role: "system",
    ...
    ], ["tone_options", "slop_rule", "transcript"], "lib/slideshow-tone-analysis.ts"),
    generationChainContent: chatPrompt("lumenclip/generation-chain-content", [
        { role: "system", content: "{{system_prompt}}" },
        { role: "user", content: "{{content_prompt}}" },
    ], ["system_prompt", "content_prompt"], "lib/generation-chain.ts"),
    generationChainHumanize: chatPrompt("lumenclip/generation-chain-humanize", [
        { role: "system", content: "{{system_prompt}}" },
        { role: "user", content: "{{user_prompt}}" },
    ], ["system_prompt", "user_prompt"], "lib/generation-chain.ts"),
    generationChainReview: chatPrompt("lumenclip/generation-chain-review", [
        { role: "system", content: "{{system_prompt}}" },
        { role: "user", content: "{{user_prompt}}" },
    ], ["system_prompt", "user_prompt"], "lib/generation-chain.ts"),
    xStrategyBrief: chatPrompt("lumenclip/x-strategy-brief", [
        {
            role: "system",
    ...
    ], ["niche"], "lib/x-automation-generation.ts"),
    xStructuredPost: chatPrompt("lumenclip/x-structured-post", [
        { role: "system", content: "{{system_prompt}}" },
        { role: "user", content: "{{user_prompt}}{{repair_feedback}}" },
    ], ["system_prompt", "user_prompt", "repair_feedback"], "lib/x-automation-generation.ts"),
    linkedinStrategyBrief: chatPrompt("lumenclip/linkedin-strategy-brief", [
        {
            role: "system",
    ...
    ], ["niche"], "lib/linkedin-automation-generation.ts"),
    linkedinStructuredPost: chatPrompt("lumenclip/linkedin-structured-post", [
        { role: "system", content: "{{system_prompt}}" },
        { role: "user", content: "{{user_prompt}}{{repair_feedback}}" },
    ], ["system_prompt", "user_prompt", "repair_feedback"], "lib/linkedin-automation-generation.ts"),
    ugcProductAnalysis: chatPrompt("lumenclip/ugc-product-analysis", [
        {
            role: "system",
    ...
    ], ["product_context"], "lib/ugc-video-generation.ts"),
    ugcScript: chatPrompt("lumenclip/ugc-script", [
        {
            role: "system",
    ...
    ], ["script_context"], "lib/ugc-video-generation.ts"),
    tiktokCommentReply: chatPrompt("lumenclip/tiktok-comment-reply", [
        { role: "system", content: "{{system_prompt}}" },
        { role: "user", content: "{{comment_context}}" },
    ], ["system_prompt", "comment_context"], "lib/tiktok-comment-replies.ts"),
    slideshowText: chatPrompt("lumenclip/slideshow-text", [
        { role: "system", content: "{{system_prompt}}" },
        { role: "user", content: "{{user_prompt}}" },
    ], ["system_prompt", "user_prompt"], "lib/slideshow-text-generation-payload.ts; lib/temp-slide-testing-shared.ts"),
    slideshowHookResearch: chatPrompt("lumenclip/slideshow-hook-research", [
        {
            role: "system",
    ...
    ], ["automation_name", "hook"], "lib/slideshow-generation-engine.ts"),
    slideshowVisualConcepts: chatPrompt("lumenclip/slideshow-visual-concepts", [
        {
            role: "system",
    ...
    ], ["slides"], "lib/slideshow-image-matching.ts"),
    slideshowImageSelection: chatPrompt("lumenclip/slideshow-image-selection", [
        {
            role: "system",
    ...
    ], ["slide_context"], "lib/slideshow-image-matching.ts"),
    slideshowSequencePlan: chatPrompt("lumenclip/slideshow-sequence-plan", [
        {
            role: "system",
    ...
    ], ["planning_context"], "lib/automation-runner.ts"),
};
export function normalizeLumenclipChatPrompt(value) {
...
export function lumenclipChatPromptsEqual(current, expected) {
