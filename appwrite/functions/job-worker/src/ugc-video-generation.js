// Generated from lib/ugc-video-generation.ts. Do not edit by hand.
...
export async function resolvePublicProductUrl(value) {
...
export function validateUgcScriptPlan(value, targetDurationSeconds = 60) {
    if (!value || typeof value !== "object")
        throw new Error("Invalid UGC script");
    const record = value;
    const segments = Array.isArray(record.segments)
        ? record.segments.map((item) => item)
        : [];
    for (const phase of ["hook", "problem", "solution", "cta"])
        if (!segments.some((segment) => segment.phase === phase && segment.spokenText?.trim()))
    ...
    return {
        ...
        hashtags: Array.isArray(record.hashtags)
            ...
            : [],
        hookOverlay: typeof record.hookOverlay === "string" ? record.hookOverlay : undefined,
...
const analysisSchema = {
    ...
    schema: {
        ...
        properties: Object.fromEntries(["product", "cta"]
