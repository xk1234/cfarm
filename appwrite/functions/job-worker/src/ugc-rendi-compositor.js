...
import { downloadRendiOutputBytes, pollRendiCommand, submitRendiCommand, uploadBytesToRendi, } from "./rendi-client.js";
...
const escapeAssStyle = (value) => String(value)
...
const escapeDrawtext = (value) => String(value)
    ...
    .replaceAll("]", "\\]")
    .replaceAll("\n", " ");
const safeAlias = (value) => /^[A-Za-z0-9._-]{1,80}$/.test(value)
    ? value
    : (() => {
