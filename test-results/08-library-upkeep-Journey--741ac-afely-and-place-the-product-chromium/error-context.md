...
- Name: 08-library-upkeep.spec.ts >> Journey 8 — launch-prep library curation >> import scenes, lock product assets, prune safely, and place the product
- Location: e2e/08-library-upkeep.spec.ts:12:3
